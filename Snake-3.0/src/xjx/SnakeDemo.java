	...
	@SuppressWarnings("deprecation")
 	public void HitWall(){//判断是否撞墙
		if(current_direction == "L")
		{
			...
			{
				ifcount = false;
				new AePlayWave("C:\\Users\\16770\\Documents\\ceshi\\over.wav").start();
				isrun = false;
					...
					{	
						...
						if(!hit_flag)
						{
							...
							if(EatFood())
							{
								...
								new AePlayWave("C:\\Users\\16770\\Documents\\ceshi\\eat.wav").start();
							}
						}
					...
					if(isrun && !pause && startfire)
					{
						...
						if(running == "L")
						{
							...
							else
							{
								...
								{
									new AePlayWave("C:\\Users\\16770\\Documents\\ceshi\\explode.wav").start();
